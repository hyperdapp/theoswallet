...
var sendTxCtrl = function($scope, $sce, walletService, $rootScope) {
    ...
    $scope.sendTx = function() {
        ...
        uiFuncs.sendTx($scope.signedTx, function(resp) {
            if (!resp.isError) {
                var checkTxLink = "https://www.wallet.hyperdapp.org?txHash=" + resp.data + "#check-tx-status";
                ...
                var emailBtn = '<a class="btn btn-xs btn-info " href="mailto:support@wallet.hyperdapp.org?Subject=Issue%20regarding%20my%20TX%20&Body=' + emailBody + '" target="_blank" rel="noopener noreferrer">Confused? Email Us.</a>';
