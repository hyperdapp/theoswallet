...
X_HelpfulLinks_4                :  'Wallet으로/에서 지갑 옮기기',
...
/* Onboarding */
ONBOARD_welcome_title           :  'wallet.hyperdapp.org에 오신 것을 환영합니다.',
...
ONBOARD_welcome_content__5      :  'Wallet은 자유 오픈소스 클라이언트 인터페이스입니다.',
...
ONBOARD_bank_title              :  'Wallet은 은행이 아닙니다',
...
ONBOARD_interface_title         :  'Wallet은 인터페이스입니다',
ONBOARD_interface_content__1    :  'Wallet에서 계정을 만들면, 개인 키와 공개 키(주소)와 같은 암호화 숫자 세트가 생성됩니다.',
...
ONBOARD_blockchain_content__4   :  '블록체인의 블록은 Wallet, MetaMask, Exodus, Mist, Geth, Parity 등에 의해 전송된 모든 개별 트랜잭션으로 구성됩니다.',
ONBOARD_blockchain_content__5   :  'wallet.hyperdapp.org 혹은 [etherscan.io](https://etherscan.io)을 통해서 보는 잔액은 개인 시스템이 아닌 블록체인의 데이터를 보고 있는 것입니다.',
...
ONBOARD_whymew_title            :  'Wallet이 이러한 것을 할수 없다면 요점은 무엇인가?',
...
ONBOARD_whymew_content__6       :  '걱정스러워도 MEW를 사용하고자 한다면, [하드웨어 지갑을 구입하세요](https://kb.wallet.hyperdapp.org/hardware-wallets/hardware-wallet-recommendations.html)! 키를 안전하게 보존해줍니다.',
ONBOARD_why_title__alt          :  '그런데...왜?',
ONBOARD_secure_title            :  '어떻게 하면 당신과 당신 자금을 지킬 수 있을까',
ONBOARD_secure_1_title          :  '피싱범으로부터 자신을 지키는 방법',
ONBOARD_secure_1_content__1     :  '피싱범은 Wallet, EtherDelta, Paypal 또는 은행과 유사하게 보이는 웹 사이트로 가는 링크가 담긴 메시지를 보내지만, 이것은 진짜 웹 사이트가 아닙니다. 피싱 사이트는 당신의 정보와 돈을 훔칩니다.',
ONBOARD_secure_1_content__2     :  '[EAL](https://chrome.google.com/webstore/detail/etheraddresslookup/pdknmigbbbhmllnmgdfalmedcmcefdfn)을 설치하거나 [MetaMask](https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn) 혹은 [Metacert에서 제공하는 Cryptonite](https://chrome.google.com/webstore/detail/cryptonite-by-metacert/keghdcpemohlojlglbiegihkljkgnige) 혹은 [Wallet 크롬 확장 프로그램](https://chrome.google.com/webstore/detail/myetherwallet-cx/nlbmnnijcnlegkjjpcfjclmcfggfefdm)을 설치해서 악성 웹사이트를 차단하세요.',
ONBOARD_secure_1_content__3     :  'URL을 항상 확인하세요: `https://www.wallet.hyperdapp.org`.',
...
ONBOARD_secure_3_content__6     :  '[더 많은 보안 팁!](https://kb.wallet.hyperdapp.org/getting-started/protecting-yourself-and-your-funds.html)',
...
NAV_TxStatus                : 'TX 상태',
tx_Details                  : '트랜잭션 내역',
tx_Summary                  : '거래량이 높은 기간(예를 들어 ICO 기간중)의 트랜잭션은 몇 시간 동안 보류될 수 있습니다. 이 도구는 이러한 TX를 찾아 "취소"하거나 교체할 수 있는 기능을 제공합니다. **이는 일반적으로 수행할 수 있는 작업이 아닙니다. 이 도구를 의존하지 말아야 하며 TX풀이 가득 찼을 때만 작동합니다. [여기서 이 도구에 대해 읽어 보십시오.](https://kb.wallet.hyperdapp.org/transactions/check-status-of-ethereum-transaction.html)**',
...
tx_notFound_4               : '오른쪽 상단에 있는 드롭 다운 목록에서 다른 ETH노드를 선택한 다음 (예. `ETH (Etherscan.io)` 혹은 `ETH (Infura.io)` 혹은 `ETH (Wallet)`) 다시 확인합니다.',
...
GEN_Help_12                 : 'Wallet(혹은 Mist, Geth, Parity 혹은 다른 지갑 클라이언트 사용.)을 통해서 지갑을 풀어냅니다.',
...
TXFEE_Desc                  : 'TX 수수료는 TX를 포함한 블록을 캔 채굴자에게 지불됩니다. 이는 `가스 한도` * `가스 가격` 입니다. [GWEI단위 -> ETH단위로 변환할 수 있습니다.](https://www.wallet.hyperdapp.org/helpers.html)',
...
/* Footer */
FOOTER_1                    : '자유롭게 쓸 수 있는 무료 오픈소스 클라이언트 인터페이스로서, 이더리움 지갑 생성 등을 지원합니다. 이더리움 블록체인과 쉽고 안전하게 상호 작용하세요. 지갑을 열기 전에 URL(wallet.hyperdapp.org)을 다시한번 확인하세요. ',
FOOTER_1b                   : '개발자 ',
...
sidebar_donation            : 'Wallet은 개인정보보호와 보안을 위한 무료 오픈 서비스입니다. 기부가 늘어날수록 우리는 새로운 기능과 다양한 의견을 반영하여 사용자가 원하는 것을 제공할 수 있습니다. 두명으로 구성된 저희 팀이 세상을 바꾸려 하고 있습니다. 도와주시겠습니까? ',
sidebar_donate              : '기부 ',
...
ADD_Ledger_0a               : 'Wallet을 보안 연결(SSL)로 다시 연결해주세요. ',
ADD_Ledger_0b               : 'Wallet을 [Chrome](https://www.google.com/chrome/browser/desktop/) 또는 [Opera](https://www.opera.com/) 브라우저로 다시 열어주세요. ',
...
ADD_DigitalBitbox_0a        : 'Wallet을 보안 연결(SSL)로 다시 연결해주세요. ',
ADD_DigitalBitbox_0b        : 'Wallet을 [Chrome](https://www.google.com/chrome/browser/desktop/) 또는 [Opera](https://www.opera.com/) 브라우저로 다시 열어주세요. ',
ADD_DigitalBitbox_scan      : 'Digital Bitbox에 연결하기 ',
x_Secalot                   : 'Secalot ',
ADD_Secalot_0a              : '보안(SSL) 연결로 Wallet 다시 열기 ',
ADD_Secalot_0b              : 'Wallet을 [Chrome](https://www.google.com/chrome/browser/desktop/) 혹은 [Opera](https://www.opera.com/)로 다시 열기 ',
...
MYWAL_Content_3             : '나중에 이 지갑을 Wallet CX와 같이 사용하려면, 개인 키/JSON과 비밀번호를 이용하여 수동으로 다시 추가해야 합니다. ',
...
TRANS_data                  : '데이터 ',
TRANS_gas                   : '가스 한도 ',
TRANS_sendInfo              : '21000 가스를 사용하는 표준 트랜잭션은 0.000441 ETH 를 사용합니다. Wallet은 트랜잭션 수수료를 받지 않습니다. ',
...
NODE_Warning                : 'wallet.hyperdapp.org을 통해 로컬 노드로 연결하기 위해서는 로컬 노드가 HTTPS를 지원해야 합니다. 이를 지원하지 않는 노드에 연결하려면 [Wallet 저장소를 다운로드하여 로컬로 실행](https://github.com/kvhnuke/etherwallet/releases/latest)하거나, 로컬 노드에 무료 SSL 인증서 [LetsEncrypt](https://letsencrypt.org/)를 설치하세요. ',
NODE_Name                   : '노드 명 ',
NODE_Port                   : '노드 포트 ',
...
ERROR_17                    : '(error_18) 잔액이 부족합니다. 가스 한도 * 가스 가격 + 보낼 수량 총합이 현 계정 잔액보다 부족합니다. 계정에 ETH를 보충하거나 "모든 잔액 전송" 버튼을 누르세요. 이것이 오류라고 생각한다면 생성 버튼을 다시 누르세요. 필요한 수량 (d+)과 실제 수량: (d+). [더 배우기](https://kb.wallet.hyperdapp.org/transactions/transactions-not-showing-or-pending.html)',
...
ERROR_28                    : '(error_29) 지갑에 액세스하기 위해서는 **키스토어 파일과 비밀번호** (또는 개인키)가 필요합니다. 별도로 저장하여 백업해주세요. 만약 그것을 저장하지 않으면 지갑을 복원할 방법이 없습니다. 자세한 내용은 [도움말 페이지](https://www.wallet.hyperdapp.org/#help)를 참고해주세요. ',
...
ERROR_35                    : '(error_36) 입력된 주소가 체크섬되어있지 않습니다. <a href="https://kb.wallet.hyperdapp.org/addresses/what-does-checksummed-mean.html" target="_blank" rel="noopener noreferrer"> 더 보기</a>', // 35
...
HELP_Desc                   : '잘못된 부분이나 다른 질문이 있으신가요? [우리에게 연락해주세요](mailto : support@wallet.hyperdapp.org), 당신의 질문에 답변하는 것 뿐만 아니라, 향후 사용자들에게 더 유용할 수 있도록 페이지를 업데이트할 것입니다. ',
HELP_Remind_Title           :  '몇 가지 알림 ',
HELP_Remind_Desc_1          : '**이더리움, wallet.hyperdapp.org & Wallet CX, 그리고 우리가 사용하는 JavaScript 라이브러리는 활발하게 개발되고 있습니다. ** 우리가 철저하게 테스트를 진행하여 수만 개의 지갑이 전 세계 사람들에 의해 성공적으로 만들어졌지만 예상치 못한 일이 발생하여 ETH를 잃을 가능성이 항상 존재합니다. 항상 조심해주세요. 만약 무슨 일이 발생한다면, 유감스럽지만 **우리는 잃어버린 이더리움에 대한 책임을 지지 않습니다.** ',
HELP_Remind_Desc_2          : 'wallet.hyperdapp.org과 Wallet CX는 웹 지갑이 아닙니다. 계정을 만들거나 우리에게 당신이 가진 이더리움을 주면 안 됩니다. 모든 데이터는 당신의 컴퓨터와 브라우저에 남아 있을 것입니다. 우리는 당신이 쉽게 당신의 정보를 만들고, 저장하고, 접근하고 블록체인과 상호 작용할 수 있도록 도울 것입니다. ',
...
HELP_0_Desc_1               : 'Wallet은 새로운 지갑을 생성할 수 있는 기능을 제공하므로 거래소에 이더리움을 두지 않고 직접 저장할 수 있습니다. 이 과정은 전적으로 당신의 컴퓨터에서 발생하고 우리의 서버에서 발생하지 않습니다. 따라서 새로운 지갑을 만들 때 **안전하게 백업해야 합니다**. ',
...
HELP_2b_Title               : '2b) 어떻게 하면 Wallet을 이용해 안전하게 오프라인, 콜드 스토리지로 자산을 보관할 수 있나요?  ',
...
HELP_3_Desc_3               : 'wallet.hyperdapp.org에서 "지갑 정보 보기" 페이지로 이동합니다. ',
...
HELP_3_Desc_8               : '많은 양의 이더리움을 Wallet 으로 전송하기 전에, 소량의 이더리움을 전송해 보는 것을 권장합니다. 0.001 이더리움을 지갑으로 전송하고, 지갑을 열어 받은 이더리움을 확인하고, 다시 0.001 이더리움을 다른 주소로 전송하여 모든 과정이 잘 작동하는지 확인해주세요. ',
...
HELP_4CX_Title              : '4) 이더리움을 Wallet CX를 사용하여 전송하는 방법이 궁급합니다. ',
...
HELP_5_Title                : '5) wallet.hyperdapp.org을 오프라인/로컬에서 사용할 수 있나요?  ',
HELP_5_Desc_1               : 'Wallet을 GitHub 서버가 아닌 본인의 컴퓨터에서 이용할 수 있습니다. 오프라인 상태에서 지갑을 생성할 수 있으며, "오프라인 트랜잭션" 페이지에서 트랜잭션을 전송할 수 있습니다. ',
HELP_5_Desc_7               : 'wallet.hyperdapp.org은 이제 본인의 컴퓨터에서 구동됩니다. ',
HELP_5_Desc_8               : '아직 사용이 미숙할 때는, `index.html` 뿐만 아니라 웹사이트를 가동하는 전체 폴더를 수정하지 말아 주세요. ',
HELP_5_Desc_9               : '우리는 wallet.hyperdapp.org을 주기적으로 업데이트하고 있으므로 당신이 정기적으로 저장소의 업데이트된 버전을 사용하는 것을 권장합니다. ',
...
HELP_8_Title                : '8) Wallet 서버가 다운되면 어떻게 되나요? ',
HELP_8_Desc_1               : 'Wallet은 웹 지갑이 아닙니다. 서버에는 로그인은 물론 어떠한 것도 저장되지 않습니다. Wallet은 단지 블록체인에 접근 하게 해주는 도구입니다. ',
HELP_8_Desc_2               : '만약 wallet.hyperdapp.org이 다운된다면, 다른 대안 도구(geth 또는 Ethereum Wallet / Mist 등)를 사용해야 합니다. 이때 Wallet에서 이더리움을 "꺼내야" 할 필요는 없습니다. 이더리움은 wallet.hyperdapp.org을 통해서 생성된 지갑 내에 존재합니다. ',
HELP_8_Desc_3               : '암호화되지 않은 개인 키와 암호화된 Geth/Mist 형식의 파일은 쉽게 geth / 이더리움 지갑 / Mist에서 불러올 수 있습니다. 아래의 질문 #12를 확인해주세요. ',
HELP_8_Desc_4               : '또한, Wallet이 다운 될 가능성은 희박합니다. 우리는 어떠한 정보도 저장하지 않기 때문에 비용이 들지 않습니다. 도메인이 다운되더라도, 항상 공개적으로  [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages)을 통해 로컬 지갑을 시작할 수 있습니다. ZIP 파일을 다운 받아주세요. ',

HELP_8CX_Title             : '8) Wallet CX가 사라지면 어떻게 되나요? ',
HELP_8CX_Desc_1             : '우선, 모든 정보는 Wallet 서버가 아닌 사용자의 컴퓨터에 저장됩니다. 오해할 수도 있지만, Chrome 확장 프로그램 화면은 우리의 서버에서 불러온 것이 아닙니다. 전부 사용자의 컴퓨터에 저장 되어있습니다. ',
HELP_8CX_Desc_2             : '즉, **매우 중요** Wallet CX 로 새로 만든 지갑 정보는 모두 백업해 두어야 합니다. 만약 컴퓨터에 문제가 생기거나 Chrome 확장 프로그램에 문제가 생겨도 백업해둔 파일로 지갑에 접근할 수 있습니다. #2a에서 지갑을 어떻게 백업 하는 지 확인할 수 있습니다. ',
HELP_8CX_Desc_3             : '어떤 이유로 Wallet CX 가 Chrome 스토어에서 사라져도, Github 에서 소스를 다운 받아 수동으로 사용할 수 있습니다. 위의 #5를 확인해주세요. ',
...
HELP_12_Title               : '12) Wallet으로 만든 지갑을 geth / 이더리움 지갑 / Mist로 가져오려면 어떻게 해야 하나요? ',
HELP_12_Desc_1              : 'Wallet v2 +의 Geth / Mist JSON 파일 사용하기… ',
...
HELP_14_Title               : '14) 일부 사이트에서는 마우스의 움직임을 통해 무작위(씨드)로 개인 키를 생성합니다. wallet.hyperdapp.org은 이 방식을 사용하지 않습니다. Wallet의 무작위 숫자 생성이 안전할까요? ',
HELP_14_Desc_1              : '대상을 움직이는 마우스는 영리하게 작동하며 우리는 사람들이 그것을 좋아하는 이유를 이해하지만, 실제 window.crypto는 당신의 마우스 조작보다 더 많은 엔트로피를 보장합니다. 마우스의 조작은 안전하지 못합니다. 우리와 다른 많은 암호 실험들은 window.crypto를 신뢰합니다. 게다가 wallet.hyperdapp.org은 터치 장치에서도 이용될 수 있습니다. [화난 Reddit 이용자와 비탈릭의 마우스 조작 v. window.crypto에 대한 대화](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) 및 [window.crypto w3 스펙](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GloblCrypto)을 참조하세요. ',
...
HELP_SecCX_Desc_6           : '별명과 지갑 주소를 암호화하면 계정 잔액과 별명을 확인할 때마다 비밀번호를 입력해야 합니다. 보안이 걱정된다면 Chrome 확장 프로그램 대신 wallet.hyperdapp.org을 이용해주세요. ',
...
HELP_Sec_Desc_4             : '이 URL을 확인해보세요. -- 이 사이트는 GitHub를 통해 소스가 공개되어 있으며 다음 링크에서 확인하실 수 있습니다. : [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) to [https://www.wallet.hyperdapp.org](https://www.wallet.hyperdapp.org). ',
