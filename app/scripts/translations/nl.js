...
tx_Summary                  : 'Ten tijden van hoog transactie volume (zoals tijdens ICOs) kunnen transacties voor uren, zo niet dagen, "pending" blijven. Deze tool heeft als doel om je de mogelijkheid te geven om deze TXs op te sporen en ze te "annuleren" / vervangen. ** Dit is niet typisch iets wat je kunt doen. Je zou er niet op moeten vertrouwen dat dit werkt & het kan alleen werken als de TX Pools vol zitten. [Lees hier meer over deze tool.](https://kb.wallet.hyperdapp.org/transactions/check-status-of-ethereum-transaction.html)**',
...
tx_notFound_4               : 'Gebruik het drop-down menu in de rechterbovenhoek & selecteer een andere ETH node (bijvoobeeld `ETH (Etherscan.io)` of `ETH (Infura.io)` of `ETH (Wallet)`) en check opnieuw.',
...
tx_FoundOnChain_3           : '**Als je geen enkele foutmelding ziet is je transactie met succes verzonden.** Je ETH of Tokens zijn waar je ze naar verzonden hebt. Als je je verzonden ETH of Tokens niet gecrediteerd ziet in je andere wallet / exchange account, en het is inmiddels al 24+ uur geleden sinds je de transactie verzonden hebt, neem dan [contact op met die service](https://kb.wallet.hyperdapp.org/diving-deeper/ethereum-list-of-support-and-communities.html). Geef ze de *link* naar je transactie en vraag ze op je allerliefste manier om naar je situatie te kijken.',
...
GEN_Help_12                 : 'Gebruik het enkel om je wallet te openen via Wallet (of Mist, Geth, Parity en andere wallet clients.) ',
...
TXFEE_Desc                  : 'De TX vergoeding (`fee`) wordt betaald aan de miners om jouw TX in een blok op de blockchain op te nemen. De vergoeding is de `gas limiet` * `gas prijs`. [Je kunt hier GWEI -> ETH converteren](https://www.wallet.hyperdapp.org/helpers.html)',
...
/* Footer */
FOOTER_1                    : 'Een gratis, open source, client-side interface om Ethereum wallets te genereren &amp; meer. Wissel op een gemakkelijke &amp; veilige manier informatie uit met de Ethereum blockchain. Dubbel-check de URL/link ( wallet.hyperdapp.org ) alvorens je wallet te openen.',
...
ADD_Ledger_0a               : 'Her-open Wallet met een veilige (SSL) verbinding ',
ADD_Ledger_0b               : 'Her-open Wallet door gebruik te maken van [Chrome](https://www.google.com/chrome/browser/desktop/) of [Opera](https://www.opera.com/) ',
ADD_Ledger_scan             : 'Verbind met Ledger Wallet ',
x_Trezor                    : 'TREZOR ',
ADD_Trezor_scan             : 'Verbind met TREZOR ',
ADD_MetaMask                : 'Verbind met MetaMask ',
x_DigitalBitbox             : 'Digital Bitbox ',
ADD_DigitalBitbox_0a        : 'Her-open Wallet met een veilige (SSL) verbinding ',
ADD_DigitalBitbox_0b        : 'Her-open Wallet door gebruik te maken van [Chrome](https://www.google.com/chrome/browser/desktop/) of [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'Als je deze wallet in de toekomst nog wilt gebruiken met Wallet CX, zul je het met de hand moeten toevoegen door gebruik te maken van de prive sleutel/JSON en wachtwoord. ',
...
NODE_Warning                : 'Je node dient HTTPS te zijn om met wallet.hyperdapp.org te kunnen verbinden. Je kunt de [Wallet repo downloaden](https://github.com/kvhnuke/etherwallet/releases/latest) en lokaal uitvoeren en vervolgens met iedere node verbinden. Of, verkrijg een gratis SSL certificaat via [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Node Naam',
...
ERROR_28                    : '**Je hebt je Keystore Bestand & wachtwoord of prive sleutel nodig** om toegang tot deze wallet te verkrijgen in de toekomst. Sla het op & maak een externe back-up! Er is geen enkele manier om je wallet te herstellen als je het nu niet opslaat. Lees ook de help pagina (https://www.wallet.hyperdapp.org/#help) voor instructies. ',
...
ERROR_35                    : 'Input adres is niet ge-checksummed. <a href="https://kb.wallet.hyperdapp.org/addresses/what-does-checksummed-mean.html" target="_blank" rel="noopener noreferrer"> Meer info</a>', // 35
...
PARITY_InvalidGasLimit      : "(parity-05) Hoeveelheid gas is boven de limiet. Supplied gas limit is beyond limit. Try lowering the gas limit to 21000. [Learn More.](https://kb.wallet.hyperdapp.org/gas/what-is-gas-ethereum.html)",
...
TranslatorName_1            : '[h3ll0fr13nd](https://www.wallet.hyperdapp.org/?gaslimit=21000&to=0xB5FbCE123F12347206c881cae73A3046BA1A90bA&value=1.0#send-transaction) ',
...
HELP_2b_Title               : '2b) Hoe doe ik veilig / offline / cold storage met Wallet? ',
...
HELP_3_Desc_3               : 'Navigeer naar de wallet.hyperdapp.org "Bekijk Wallet Info" pagina. ',
...
HELP_4CX_Title              : '4) Hoe verzend ik Ether met Wallet CX? ',
...
HELP_5_Title                : '5) Hoe voer ik wallet.hyperdapp.org offline/lokaal uit? ',
HELP_5_Desc_1               : 'Je kunt wallet.hyperdapp.org uitvoeren op je eigen computer in plaats van op de GitHub servers. Je kunt een wallet volledig offline genereren en transacties versturen met behulp van de "Offline Transactie" pagina. ',
HELP_5_Desc_7               : 'wallet.hyperdapp.org draait nu volledig op jouw computer. ',
HELP_5_Desc_8               : 'Voor het geval dat je er niet bekend mee bent: je hebt de volledige map nodig om de site lokaal te draaien, niet alleen het `index.html` bestand. Laat alle bestanden in de map met rust en ga ze niet verplaatsen. Als je een back-up wilt bewaren van de Wallet repo voor de toekomst, raden we je aan om alleen de ZIP te bewaren zodat je zeker weet dat de inhoud intact blijft. ',
HELP_5_Desc_9               : 'Gezien we wallet.hyperdapp.org continu updaten, raden we je aan om regelmatig je opgeslagen versie van de repo bij te werken. ',
...
HELP_8_Desc_1               : 'Wallet is geen web wallet. Je hoeft niet in te loggen en er zal nooit iets van je op onze servers worden bewaard. Onze website is enkel een interface om toegang te verkrijgen tot de blockchain. ',
HELP_8_Desc_2               : 'Als wallet.hyperdapp.org er mee stopt, zul je een andere manier moeten zien te vinden (zoals geth of Ethereum Wallet / Mist) om te doen wat wij doen. Maar wat je niet zult hoeven te doen is je Ether uit Wallet halen omdat het niet in Wallet zit. Je Ether zit in in welk wallet dan ook je op onze site hebt gegenereerd. ',
...
HELP_12_Title               : '12) Hoe importeer ik een Wallet  wallet in geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Door gebruik te maken van een Geth/Mist JSON bestand van Wallet v2+.... ',
...
HELP_14_Title               : '14) Sommige sites zorgen voor een willekeurigheid (seed) bij het genereren van de prive sleutel via muis bewegingen. wallet.hyperdapp.org doet dit niet. Is de wikkeleurigheid (random number generation) van Wallet wel veilig? ',
HELP_14_Desc_1              : 'Hoewel het bewegen van de muis een slimme truck is en we begrijpen waarom mensen dit een goed idee vinden, is de werkelijkheid dat "window.crypto" een grotere willekeurigheid (hogere entropie) zeker stelt dan je muisbewegingen. De muisbewegingen zijn niet onveilig, echter wij (en enorm veel andere crypto experimenten) geloven in "window.crypto". Bovendien kan wallet.hyperdapp.org gebruikt worden op touchscreen apparaten. Hier vind je een [conversatie tussen een boze redditor en Vitalik Buterin over de muisbewegingen v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_SecCX_Title            : 'Beveiliging - Wallet CX ',
...
HELP_SecCX_Desc_6           : 'Als we deze items zouden versleutelen, zou je iedere keer dat je je saldo of nicknames wilt checken je wachtwoord moeten invoeren. Als je je hierover zorgen maakt, raden we je aan om gebruik te maken van wallet.hyperdapp.org in plaats van deze Chrome Extensie. ',
...
HELP_Sec_Desc_4             : 'Controleer de URL -- Deze website draait vanaf GitHub en je kunt de bron code hier vinden: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) naar de domein namen: [https://www.wallet.hyperdapp.org](https://www.wallet.hyperdapp.org). ',
