...
/* Onboarding */
ONBOARD_welcome_title           :  'Bienvenido a wallet.hyperdapp.org',
...
ONBOARD_welcome_content__5      :  'Wallet es una interfaz gratuita, de código abierto, del lado del cliente.',
...
ONBOARD_bank_title              :  'Wallet no es un banco',
...
ONBOARD_interface_title         :  'Wallet es una Interfaz',
ONBOARD_interface_content__1    :  'Cuando crea una cuenta en Wallet está generando un conjunto criptográfico de números: su clave privada y su clave pública (dirección).',
...
ONBOARD_blockchain_content__4   :  'Los bloques en el blockchain se componen de todas las transacciones individuales enviadas desde Wallet, MetaMask, Exodus, Mist, Geth, Parity y en cualquier otro lugar.',
ONBOARD_blockchain_content__5   :  'Cuando vea su saldo en wallet.hyperdapp.org o vea sus transacciones en [etherscan.io] (https://etherscan.io), verá datos en la cadena de bloques, no en nuestros sistemas personales.',
...
ONBOARD_whymew_title            :  'Si Wallet no puede hacer esas cosas, ¿para qyé sirve?',
...
ONBOARD_whymew_content__6       :  'Si tiene miedo pero quiere usar MEW, [consiga una billetera de hardware](https://kb.wallet.hyperdapp.org/hardware-wallets/hardware-wallet-recommendations.html)! These keep your keys secure.',
...
ONBOARD_secure_1_content__1     :  'Phishers le envía un mensaje con un enlace a un sitio web que se parece a Wallet, EtherDelta, Paypal o a su banco, pero no es el sitio web real. Le roban su información y luego le roban su dinero.',
...
ONBOARD_secure_1_content__3     :  'Siempre revisa la URL: `https://www.wallet.hyperdapp.org`.',
...
ONBOARD_secure_3_content__6     :  '[¡Aún más consejos de seguridad!](https://kb.wallet.hyperdapp.org/getting-started/protecting-yourself-and-your-funds.html)',
...
tx_notFound_4               : 'Por favor usa el desplegable en la parte superior derecha y selecciona un nodo ETH diferente (ej. `ETH (Etherscan.io)` o `ETH (Infura.io)` o `ETH (Wallet)`) y comprueba de nuevo.',
...
tx_FoundOnChain_3           : '**If you do not see any errors, your transaction was successfully sent.** Your ETH or Tokens are where you sent them. If you cannot see this ETH or Tokens credited in your other wallet / exchange account, and it has been 24+ hours since you sent, please [contact that service](https://kb.wallet.hyperdapp.org/diving-deeper/ethereum-list-of-support-and-communities.html). Send them the *link* to your transaction and ask them, nicely, to look into your situation.',
...
GEN_Help_12                 : 'Úselo para desbloquear su billetera a través de Wallet (o Mist, Geth, Parity y otros clientes de billetera). ',
...
TXFEE_Desc                  : 'La tarifa de TX se paga a los mineros por incluir su TX en un bloque. Es el `límite de gas` * `precio del gas`. [Puede convertir GWEI -> ETH aquí](https://www.wallet.hyperdapp.org/helpers.html)',
...
MYWAL_Content_3             : 'Si en el futuro quieres utilizar esta cartera con Wallet CX, tendrás que volver a añadirla manualmente utilizando Clave Privada/JSON y contraseña. ',
...
NODE_Warning                : 'Tu nodo debe ser HTTPS para poder conectar a él desde wallet.hyperdapp.org. Para conectarte a cualquier nodo, puedes [descargar el repositorio de Wallet y ejecutarlo localmente](https://github.com/kvhnuke/etherwallet/releases/latest). También puedes conseguir un certificado SSL gratuito a través de [Let\'s Encrypt](https://letsencrypt.org/)',
...
ADD_Ledger_0a               : 'Volver a abrir Wallet en una conexión segura (SSL) ',
ADD_Ledger_0b               : 'Volver a abrir Wallet usando [Chrome](https://www.google.com/chrome/browser/desktop/) u [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Volver a abrir Wallet en una conexión segura (SSL) ',
ADD_DigitalBitbox_0b        : 'Volver a abrir Wallet usando [Chrome](https://www.google.com/chrome/browser/desktop/) u [Opera](https://www.opera.com/) ',
...
ERROR_28                        :  '(error_29) **Necesitas tu archivo Keystore/JSON y la contraseña** (o clave privada) para acceder a esta cartera en el futuro. Por favor ¡guárdala y respáldala externamente! No hay modo de recuperar una cartera si no la guardas. Lee la [página de ayuda](https://www.wallet.hyperdapp.org/#help) para instrucciones. You need this `Keystore File + Password` or the `Private Key` (next page) to access this wallet in the future. ', // 28
...
ERROR_35                        :  '(error_36) Input address is not checksummed. <a href="https://kb.wallet.hyperdapp.org/addresses/what-does-checksummed-mean.html" target="_blank" rel="noopener noreferrer"> More info</a>Input address is not checksummed. <a href="https://kb.wallet.hyperdapp.org/addresses/what-does-checksummed-mean.html" target="_blank" rel="noopener noreferrer">What does that mean?</a>', // 35
...
HELP_2b_Title               : '2b) ¿Cómo almaceno con seguridad/sin conexión/en frío con Wallet? ',
...
HELP_3_Desc_3               : 'Ve a la página "Ver Información de las Carteras" de wallet.hyperdapp.org. ',
...
HELP_4CX_Title              : '4) ¿Cómo envío ether utilizando Wallet CX? ',
...
HELP_5_Title                : '5) ¿Cómo ejecuto wallet.hyperdapp.org sin conexión/localmente? ',
HELP_5_Desc_1               : 'Puedes ejecutar wallet.hyperdapp.org en tu equipo en lugar de desde los servidores de GitHub. Puedes generar una cartera totalmente sin conexión y enviar transacciones desde la página "Transacción sin conexión". ',
HELP_5_Desc_7               : 'wallet.hyperdapp.org is now running entirely on your computer. ',
HELP_5_Desc_8               : 'Por si no tienes costumbre, es necesario guardar la carpeta completa para ejecutar la página web, no solamente `index.html`. No modifiques ni muevas nada dentro de la carpeta. Si estás guardando una copia del repositorio Wallet para el futuro, recomendamos guardar únicamente el fichero ZIP para poder estar seguro de que el contenido permanezca intacto. ',
HELP_5_Desc_9               : 'Debido a que estamos constantemente actualizando wallet.hyperdapp.org, recomendamos que actualices periódicamente tu versión guardada del repositorio. ',
...
HELP_8_Desc_1               : 'Wallet no es una cartera web. No tienes un login y nunca se graba nada en nuestros servidores. You don\'t have a login and nothing ever gets saved to our servers. Simplemente es una interfaz que te permite interactuar con la cadena de bloques. ',
HELP_8_Desc_2               : 'Si wallet.hyperdapp.org desapareciera, tendrías que encontrar otra manera de poder hacer lo que haces con nosotros (como por ejemplo obtener geth o Ethereum Wallet / Mist). Pero no necesitarías retirar tus ether de Wallet porque no están en Wallet. Están en la cartera que hayas generado a través de nuestro sitio. ',
...
HELP_8_Desc_4               : 'Además, la probabilidad de que cerremos Wallet es casi nula. No nos cuesta prácticamente nada mantenerlo ya que no almacenamos ninguna información. Si borramos el dominio, continúa estando disponible y siempre lo estará en [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Puedes descargar desde ahí el archivo ZIP y ejecutarlo localmente. ',

HELP_8CX_Title              : '8) ¿Qué ocurre si Wallet CX desaparece? ',
...
HELP_8CX_Desc_2             : 'Dicho esto, es **muy importante** que respaldes toda tu información para todas las nuevas carteras generadas con Wallet CX. De este modo, si algo le ocurre a Wallet CX o a tu equipo, seguirás teniendo toda la información necesaria para poder acceder a tus ether. Ver la pregunta #2a sobre cómo respaldar tus carteras. ',
HELP_8CX_Desc_3             : 'Si por algún motivo Wallet CX desaparece de Chrome Store, puedes encontrar el código fuente en Github y cargarlo manualmente. Ver #5 más arriba. ',
...
HELP_14_Desc_1              : 'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experments) believe in window.crypto. In addition, wallet.hyperdapp.org can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_SecCX_Title            : 'Seguridad - Wallet CX ',
...
HELP_SecCX_Desc_6           : 'Si cifráramos estos ítems, sería necesario que introduzcas una contraseña cada vez que quisieras comprobar el saldo de tu cuenta o vizualizar los alias. Si esto te preocupa, te recomendamos que utilices wallet.hyperdapp.org en lugar de esta extensión de Chrome. ',
...
HELP_Sec_Desc_4             : 'Comprueba la URL -- Este sitio se sirve a través de GitHub y puedes ver el código fuente aquí: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) a [https://www.wallet.hyperdapp.org](https://www.wallet.hyperdapp.org). ',
