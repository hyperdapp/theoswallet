...
sidebar_donation            : 'Wallet is a free, open-source service dedicated to your privacy and security. The more donations we receive, the more time we spend creating new features, listening to your feedback, and giving you what you want. We are just two people trying to change the world. Help us? ',
sidebar_donate              : 'تبرع ',
sidebar_thanks              : 'شكرا!!! ',
...
ADD_Ledger_0a               : 'You must access Wallet via a secure(SSL / HTTPS) connection to connect.',
...
MYWAL_Content_3             : 'If you want to use this wallet with your Wallet CX in the future, you will need to manually re-add it using the private key/JSON and password. ',
...
ADD_Ledger_0a               : 'Réouvrir Wallet sur une connexion sécurisée (SSL) ',
ADD_Ledger_0b               : 'Réouvrir Wallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/) ',
x_Trezor                    : 'TREZOR ',
ADD_Trezor_scan             : 'Connexion au TREZOR ',
ADD_Trezor_select           : 'Ceci est une _seed_ TREZOR ',
x_DigitalBitbox             : 'Digital Bitbox ',
ADD_DigitalBitbox_0a        : 'Réouvrir Wallet sur une connexion sécurisée (SSL) ',
ADD_DigitalBitbox_0b        : 'Réouvrir Wallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/) ',
...
GETH_GasLimit                   :  '(geth-03) Exceeds block gas limit. Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://kb.wallet.hyperdapp.org/gas/what-is-gas-ethereum.html)',
...
TranslatorName_1            : '[bstashio](https://www.wallet.hyperdapp.org/?gaslimit=21000&to=0xD8FE791535Ad85D2b0E76e603443C1b39107729F&value=1.0#send-transaction) · ',
